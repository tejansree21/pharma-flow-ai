    ...
    <div className="app-layout">
      <aside className="sidebar">
        ...
        <div style={{ padding: '0 12px 12px' }}>
          <div
            style={{ display:'flex',alignItems:'center',gap:8,padding:'10px 12px',borderRadius:8,background:'rgba(220,38,38,0.08)',border:'1px solid rgba(239,68,68,0.18)',cursor:'pointer',fontSize:12,fontWeight:500,color:'#f87171',transition:'all 0.2s ease' }}
        ...
        <div className="sidebar-footer">
          ...
          <div style={{marginTop:8,fontSize:10,color:'var(--text-muted)',textAlign:'center'}}>Phase 8 — Scenario Simulation</div>
        </div>
      </aside>
      ...
      <main className="main-content">
        <div className="topbar">
          ...
          <div className="topbar-right">
            <button
              onClick={() => document.getElementById('ask-pharmaflow-fab')?.click()}
              style={{display:'flex',alignItems:'center',gap:6,padding:'7px 14px',background:'rgba(220,38,38,0.1)',border:'1px solid rgba(239,68,68,0.25)',borderRadius:8,color:'#f87171',fontSize:12,fontWeight:600,cursor:'pointer',fontFamily:'var(--font)',transition:'all 0.2s ease'}}
